...
class PdcController extends Controller
{
    ...
    public function SaveRelicaPrimo(Request $request)
    {
        $rules = [
            ...
            // Optional fields (if they exist in SaveFdsOps but are optional here)
        ...
        try {
            ...
            */
            ...
            return response()->json([
                'success' => true,
                'message' => 'RELICA-PRIMO créé avec succès',
                'data' => $dossier
            ], 201);
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function savePdcImmatriculationData(Request $request)
    {
        ...
        if ($existingDossier) {
            return response()->json([
                'success' => false,
                'message' => 'Oups! une Opération Speciale est déjà en cours pour ce véhicule.'
            ], 409); // 409 Conflict
        }
