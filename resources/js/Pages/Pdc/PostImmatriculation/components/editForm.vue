                                ...
                                <div class="grid gap-3 md:grid-cols-2 md:gap-10 lg:grid-cols-3 mb-5">
                                    ...
                                    <FormField v-slot="{ componentField }" name="carrosserie">
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Berline" v-bind="componentField" :disabled="!selected.includes(
                                                    'Changement-Carrosserie',
                                                )
                                    ...
                                    <FormField v-slot="{ componentField }" name="typeTechnique">
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Input placeholder="type Technique" v-bind="componentField" :disabled="!selected.includes(
                                                    'Changement Type Technique',
                                                )
                                ...
                                <div class="grid gap-3 md:grid-cols-2 md:gap-10 lg:grid-cols-3 mb-5">
                                    ...
                                    <!-- <FormField v-slot="{ componentField }" name="usage">
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Input placeholder="transport" v-bind="componentField" :disabled="!selected.includes(
                                                    'Usage',
                                                )
                                        ...
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Select v-bind="componentField" autocomplete="couleurVehicule"
                                                    v-model="form.usage" :disabled="!selected.includes(
                                                        'Usage',
                                                    )
                                                        ">
                                                    <SelectTrigger class="w-full">
                                    ...
                                    <FormField v-slot="{ componentField }" name="sourcesEnergie">
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Select v-bind="componentField" autocomplete="sourcesEnergie" :disabled="!selected.includes(
                                                    'Changement de Sources d’énergie',
                                                )
                                    ...
                                    <FormField v-slot="{ componentField }" name="codeRegion">
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Select v-bind="componentField" v-model="form.codeRegion" :disabled="!selected.includes(
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                            ...
                                            <p>
                                                <strong>Puissance administrative
                                                    :</strong>
                                            ...
                                            <p v-if="
                                                ...
                                                data.sourcesEnergie
                                            ">
                                                <strong>Anciennes Sources d’énergie
                                                    :</strong>
                                                <samp class="text-[#ca7600]">{{
                                                    data.sourcesEnergie
                                                    }}</samp>
...
const fetchModeles = async () => {
    ...
    try {
        const res = await axios.get(
            `/pdc/get/model?marque_id=${selectedMarqueId.value}`,
        );
...
const formSchema = toTypedSchema(
    z.object({
        ...
        villeNaissance: z
            .string()
            .min(3, "La ville de naissance est obligatoire."),
        couleurVehicule: z
            .string()
            .min(3, "La couleur du véhicule est obligatoire."),
        ...
        puissance: z
            .string()
            .min(1, "La puissance administrative est obligatoire."),
        placesAssises: z
            .string()
            .min(1, "Le nombre de places assises est obligatoire."),
        sourcesEnergie: z
            .string()
            .min(3, "Les sources d'énergie sont obligatoires."),
        nombreEssieux: z
            .string()
            .min(1, "Le nombre d'essieux est obligatoire."),
    }),
);
...
function submitFinal() {
    ...
    axios
        .put(`/pdc/postimmatriculation/${data.id}/update`, data)
        .then((response) => {
            ...
            if (res.success) {
                toast.success(
                    res.message || "Information mise à jour avec succès !",
                );
                setTimeout(() => {
...
const getTypeService = () => {
    ...
    const index = selected.value.findIndex(
        (item) => item === "Changement de propriétaire : MUTATION",
    );
